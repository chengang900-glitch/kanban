    ...
    <SettingsPageWrapper title={t`Localization`}>
      <SettingsSection title={t`Instance settings`}>
        <AdminSettingInput
          ...
          inputType="select"
          description={t`The default language for all users across the ${applicationName} UI, system emails, subscriptions, and alerts. Each user can override this from their own account settings.`}
        />
        <AdminSettingInput
