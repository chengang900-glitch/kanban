...
export function AISettingsPage() {
  ...
  return (
    <SettingsPageWrapper
      title={t`AI features`}
      description={t`Manage your AI provider connection.`}
    >
...
function AgentApiSettingsSection({ disabled }: { disabled: boolean }) {
  ...
  return (
    <ToggleSettingsSection
      ...
      description={t`Enable external access to the Agent API.`}
