...
describe("DataStudioLayout", () => {
  ...
  describe("sidebar rendering", () => {
    it("should render the sidebar with navigation tabs", async () => {
      ...
      expect(screen.queryByLabelText("Schema viewer")).not.toBeInTheDocument();
      expect(
        screen.queryByLabelText("Dependency graph"),
      ).not.toBeInTheDocument();
      expect(
        screen.queryByLabelText("Dependency diagnostics"),
      ).not.toBeInTheDocument();
      expect(
