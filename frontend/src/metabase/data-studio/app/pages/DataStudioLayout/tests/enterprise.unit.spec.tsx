...
describe("DataStudioLayout", () => {
  ...
  describe("Set up remote sync button", () => {
    it("should hide the gated Set up remote sync button when the feature is unavailable", async () => {
  ...
  describe("sidebar rendering", () => {
    it("should render the sidebar with navigation tabs", async () => {
      ...
      expect(screen.getByText("Schema viewer")).toBeInTheDocument();
      expect(screen.getByText("Dependency graph")).toBeInTheDocument();
      expect(screen.getByText("Dependency diagnostics")).toBeInTheDocument();
    });
