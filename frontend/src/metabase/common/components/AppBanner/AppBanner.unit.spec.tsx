...
describe("AppBanner", () => {
  describe("PaymentBanner", () => {
    ...
    it("should not render past-due commercial banner for admins", () => {
      setup({
        isAdmin: true,
        tokenStatus: { ...token, status: "past-due" },
      });
    ...
    it("should not render unpaid commercial banner for admins", () => {
      setup({
        isAdmin: true,
    ...
    it("should not render invalid-token commercial banner", () => {
      setup({
        isAdmin: true,
        tokenStatus: {
          ...token,
  ...
  describe("TrialBanner", () => {
    ...
    it("should not render trial promotion with 7 or fewer days remaining", () => {
      jest.useFakeTimers();
