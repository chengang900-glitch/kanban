...
describe("MetabotAppBarButton", () => {
  it("should render the button when metabot is enabled", async () => {
    ...
    expect(
      await screen.findByRole("button", { name: /AI助手/ }),
    ).toBeInTheDocument();
  });
  ...
  it("should not render the button when metabot is globally disabled", () => {
    ...
    expect(
      screen.queryByRole("button", { name: /AI助手/ }),
  ...
  it("should disable the button on the full-page AI问数 (/question/ask) surface", async () => {
  ...
  it("should not disable the button on other question pages", async () => {
    ...
    expect(await screen.findByRole("button", { name: /AI助手/ })).toBeEnabled();
  });
