...
export type MetabotConversationSummary = {
  conversation_id: string;
  created_at: string;
  summary: string | null;
  user_id: number | null;
...
export type MetabotConversationListResponse = {
  data: MetabotConversationSummary[];
  total: number;
  limit: number;
  offset: number;
};

export type MetabotConversationDetail = Pick<
  MetabotConversationSummary,
  "conversation_id" | "created_at" | "summary" | "user_id"
> & {
...
export interface AzureCredentials {
  ...
  protocol?: "chat-completions" | "responses" | null;
}
...
export type ValidateMetabotSettingsRequest = UpdateMetabotSettingsRequest;
