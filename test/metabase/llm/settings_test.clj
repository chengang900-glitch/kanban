...
(deftest llm-openai-compatible-api-key-setter-test
  (mt/with-temp-env-var-value! [mb-llm-openai-compatible-api-key nil]
    (mt/discard-setting-changes [llm-openai-compatible-api-key]
      (llm.settings/llm-openai-compatible-api-key! "  arbitrary-provider-key  ")
      (is (= "arbitrary-provider-key"
             (llm.settings/llm-openai-compatible-api-key)))
      (llm.settings/llm-openai-compatible-api-key! "   ")
      (is (nil? (llm.settings/llm-openai-compatible-api-key))))))

(deftest llm-openai-compatible-api-base-url-setter-test
  (mt/with-temp-env-var-value! [mb-llm-openai-compatible-api-base-url nil]
    (mt/discard-setting-changes [llm-openai-compatible-api-base-url]
...
(deftest llm-openai-compatible-api-protocol-test
  (mt/with-temp-env-var-value! [mb-llm-openai-compatible-api-protocol nil]
    (mt/discard-setting-changes [llm-openai-compatible-api-protocol]
      (is (= "chat-completions"
      ...
      (is (thrown? clojure.lang.ExceptionInfo
                   (llm.settings/llm-openai-compatible-api-protocol! "auto"))))))
