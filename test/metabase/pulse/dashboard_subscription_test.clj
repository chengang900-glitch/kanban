     ...
     (fn [_ [email]]
       (is (= (rasta-dashsub-message
               {:message [{;; No "Pulse:" prefix
                           ...
                           "发送自 <a href=\\\"https://testmb.com\\\"" true
...
(deftest dashboard-subscription-email-hides-branding-test
  (testing "dashboard subscription emails never include official branding"
